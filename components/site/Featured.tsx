  ...
  return (
    <section className="py-20 px-6 bg-secondary">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Full-bleed image with glass card overlay */}
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 right-6 md:right-auto md:max-w-sm bg-white/85 backdrop-blur-md border border-blue-100 rounded-2xl p-8 flex flex-col gap-5">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              The Lumière Edit is femininity without apology.
            </p>
            <button className="self-start px-7 py-3.5 rounded-full bg-primary text-primary-foreground text-[10px] uppercase tracking-[0.18em] hover:bg-accent transition-colors duration-300">
              Shop the Edit
            </button>
          </div>
        </div>
